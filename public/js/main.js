(() => {
  ...
  var require_validateFormdata = __commonJS({
    "assets/js/lib/validateFormdata.js"(exports, module) {
      ...
      ValidateFormdata.prototype.validate = function(key, value) {
        ...
        const pristine = this.state.pristine[key];
        const required = this.state.required[key];
        const hadError = this.state.errors[key];
        const error2 = validator(value);
        this.state.errors[key] = error2 || null;
      ...
      ValidateFormdata.prototype.formData = function() {
        ...
        return Object.keys(values).reduce(function(form2, key) {
          form2.append(key, values[key]);
          return form2;
        }, new window.FormData());
      };
  ...
  var require_assertString = __commonJS({
    "node_modules/validator/lib/util/assertString.js"(exports, module) {
      ...
      function assertString(input2) {
        var isString2 = typeof input2 === "string" || input2 instanceof String;
        if (!isString2) {
          var invalidType;
          if (input2 === null) {
            invalidType = "null";
          } else {
            invalidType = _typeof(input2);
            if (invalidType === "object" && input2.constructor && input2.constructor.hasOwnProperty("name")) {
              invalidType = input2.constructor.name;
            } else {
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  var loginForm = () => Object.assign({}, form(), {
    init() {
      this.validator.field("email", (data2) => {
        ...
        if (!(0, import_isEmail.default)(data2))
          return new Error("This is not valid email address");
      });
      this.validator.field("password", (data2) => {
        if ((0, import_isEmpty.default)(data2))
  ...
  // assets/js/main.js
  module_default.directive("uppercase", (el) => {
    el.textContent = el.textContent.toUpperCase();
  });
  module_default.directive("log", (el, { expression }, { evaluateLater: evaluateLater2, effect: effect3 }) => {
    const getThingToLog = evaluateLater2(expression);
    effect3(() => {
